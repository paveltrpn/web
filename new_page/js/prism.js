/* PrismJS 1.21.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+actionscript+ada+apl+arduino+aspnet+asm6502+bash+basic+batch+c+csharp+cpp+clojure+cmake+coffeescript+css-extras+d+dart+diff+django+docker+editorconfig+elixir+elm+erlang+fsharp+fortran+gcode+git+glsl+go+groovy+haskell+hlsl+http+hpkp+hsts+ini+j+java+js-extras+json+json5+jsonp+jsstacktrace+js-templates+julia+kotlin+latex+less+lisp+llvm+lua+makefile+markdown+markup-templating+matlab+mongodb+nasm+nginx+nix+objectivec+opencl+pascal+perl+php+php-extras+powershell+prolog+python+qml+r+jsx+tsx+regex+ruby+rust+scala+smalltalk+sql+swift+tcl+textile+typescript+visual-basic+wasm&plugins=line-numbers */
